...
@interface MLLoopBannerView ()
<MLInfiniteScrollViewDataSource, UIScrollViewDelegate>
@property (strong, nonatomic) MLInfiniteScrollView *scrollView;
...
@implementation MLLoopBannerView
#pragma mark - Getters
- (UIScrollView *)scrollView
{
    if (!_scrollView) {
        __weak typeof(self)weakSelf = self;
        _scrollView = [[MLInfiniteScrollView alloc] initWithFrame:CGRectZero];
...
#pragma mark - MLMLInfiniteScrollViewDataSource
